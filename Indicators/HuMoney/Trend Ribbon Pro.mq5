...
int OnInit() {
    ...
    fastMaHandle = iMA(_Symbol, _Period, InputFastPeriod, InputMaShift,
                       InputMaMethod, InputAppliedPrice);
    slowMaHandle = iMA(_Symbol, _Period, InputSlowPeriod, InputMaShift,
                       InputMaMethod, InputAppliedPrice);
...
int OnCalculate(const int rates_total, const int prev_calculated,
    ...
    if (rates_total < MathMax(InputFastPeriod, InputSlowPeriod)) return (0);
